describe 'ValidationErrors', ->
  ...
  check_assertion = (error_type, column_name, proc) ->
    errors = {duplicated_code:[], duplicated_label:[], existing_label:[], existing_code:[], usage_missing:[], duplicated_usage: [], data_errors: []}
    proc(errors)
    val_errors = new ValidationErrors(errors)
  ...
  it "should generate redeable errors for duplicated code", ->
    ...
    check_assertion('code', 'text_column', proc_duplicated_code)
  ...
  it "should generate redeable errors for duplicated label", ->
    ...
    check_assertion('label', 'text_column', proc_duplicated_label)
  ...
  it "should generate redeable errors for duplicated usage", ->
    ...
    check_assertion('usage', 'lat', proc_duplicated_usage)