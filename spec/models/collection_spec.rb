...
describe Collection, :type => :model do
  ...
  let(:collection2) { user.create_collection Collection.make(anonymous_name_permission: 'none', anonymous_location_permission: 'none')}
  ...
  describe 'es_codes_by_field_code' do
    let(:collection_a) { user.create_collection Collection.make }
