...
#   let!(:collection) { admin.create_collection Collection.make_unsaved }
...
#       public_collection = admin.create_collection Collection.make_unsaved(anonymous_name_permission: 'read', anonymous_location_permission: 'read')
...
#       let!(:other_collection) { admin.create_collection Collection.make_unsaved }
...
#       let!(:public_collection) { admin.create_collection Collection.make_unsaved(anonymous_name_permission: 'read', anonymous_location_permission: 'read') }
...
#       let!(:public_collection) { admin.create_collection Collection.make_unsaved(anonymous_name_permission: 'read',
