...
describe ElasticSearch::SitesAdapter do
  it "adapts one site" do
    ...
    listener.should_receive(:add).with :id => 181984, :lat => -37.55442222700955, :lng => 136.5797882218185, :collection_id => 63, :type => 'site'
  ...
  it "adapts two sites" do
    listener = mock('listener')
    listener.should_receive(:add).with :id => 181984, :lat => -37.55442222700955, :lng => 136.5797882218185, :collection_id => 63, :type => 'site'
    listener.should_receive(:add).with :id => 181985, :lat => -47.55442222700955, :lng => 137.5797882218185, :collection_id => 63, :type => 'site'
