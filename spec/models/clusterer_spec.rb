...
describe Clusterer do
  ...
  it "puts two sites in a cluster" do
    ...
    clusters[:clusters].should eq([{:id => "1:2:3", :lat => 20.5, :lng => 30.5, :count => 2, :min_lat => 20, :max_lat => 21, :min_lng => 30, :max_lng => 31}])
  end
  ...
  it "puts four sites in two different clusters" do
    ...
    clusters[:clusters].should eq([
      {:id => "1:2:3", :lat => 20.5, :lng => 30.5, :count => 2, :min_lat => 20, :max_lat => 21, :min_lng => 30, :max_lng => 31},
      {:id => "1:3:4", :lat => 65.5, :lng => 120.5, :count => 2, :min_lat => 65, :max_lat => 66, :min_lng => 120, :max_lng => 121}
    ])
  end
end
